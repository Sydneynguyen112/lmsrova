...
// Ngưỡng RIÊNG để MỞ tab Quiz + Bài tập. Thấp hơn WATCH_THRESHOLD có chủ đích:
// tách riêng để chỉnh ngưỡng làm bài không đụng vào luật tính xong bài/mở bài kế.
export const WORK_WATCH_THRESHOLD = 0.4;
